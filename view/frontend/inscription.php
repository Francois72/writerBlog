...
<html>
    ...
    <form action="index.php?action=inscriptionpost" method="post"> 
        ...
        <p><label>Pseudo</label></br><input type ="text" name="user" value="" size="40" required/></p>
          ...
          <p><label>Retapez votre mot de passe</label></br><input type ="password" name="pass2" value="" size="40" required/></p>
          <p><label>Adresse email</label></br><input type ="text" name="email" value="" size="40" required/></p>  
